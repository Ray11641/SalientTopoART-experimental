"""
    ...
    This file provides TopoART class that does simple 
    partitioning and not hierarchical clustering like
...
class TopoART:
    ...
    def prune(self) -> None:
        ...
        for index in pruneLocations:
            ...
            tag = self.prototypes_["tag"].pop(index)
    ...
    def printlocallabels(self,) -> IO:
        print(self.__labels_)